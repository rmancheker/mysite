...
<div class="page-wrapper">
	<div class="page">
		...
		<?php print render($page['header']); ?>
			<div class="navigation-top"><?php if($page['navigation-top']){
				print render($page['navigation-top']);}; ?></div>
			<div class="navigation-bottom"><?php if($page['navigation-bottom']){
				print render($page['navigation-bottom']);}; ?></div>
		</div>
		...
		<div class="footer">
			<div class="footer1"><?php if($page['footer1']){
				print render($page['footer1']);};?></div>
			<div class="footer2"><?php if($page['footer2']){
				print render($page['footer2']);}; ?></div>
			<div class="footer3"><?php if($page['footer3']){
				print render($page['footer3']);}; ?></div>
			<div class="footer-middle"><?php if($page['footer-middle']){
				print render($page['footer-middle']);}; ?></div>
			<div class="footer-bottom"><?php if($page['footer-bottom']){
